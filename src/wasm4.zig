...
pub const Gamepad = packed struct {
    ...
    pub fn b1(self: Gamepad) bool {
        return self.v & 1 != 0;
    }
    pub fn b2(self: Gamepad) bool {
        return self.v & 2 != 0;
    }
    pub fn left(self: Gamepad) bool {
        return self.v & 16 != 0;
    }
    pub fn right(self: Gamepad) bool {
        return self.v & 32 != 0;
    }
    pub fn up(self: Gamepad) bool {
        return self.v & 64 != 0;
    }
    pub fn down(self: Gamepad) bool {
        return self.v & 128 != 0;
    }
};
...
pub const FRAMEBUFFER = @intToPtr(*std.PackedIntArrayEndian(u2, .Little, CANVAS_SIZE * CANVAS_SIZE), 0xA0);
